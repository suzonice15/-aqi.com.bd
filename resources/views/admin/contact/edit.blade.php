                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group featured-image">
                                            <label>Icon Image<span class="required"></span></label>
                                            <input    type="file" class="form-control" name="service_icon"/>
                                            <br>
                                            <?php

                                                if($service->service_icon){
                                            $image=url('public/uploads/service').'/'.$service->service_icon;
                                            ?>
                                        ...
                                        <div class="form-group featured-image">
                                            ...
                                            $image=url('public/uploads/service').'/'.$service->service_image;
                                            ?>
                                            <img    width="50" src="{{$image}}">
