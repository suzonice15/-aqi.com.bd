...
@section('mainContent')
    ...
    <div class="row banner-fluid">
        ...
        <div class="container-fluid banner-col">
            ...
            <div class="caption wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <h2>{{$news->news_name}}</h2>
            </div>
        </div>
        <div class="row crumb"><p><a href="{{url('/')}}">Home</a> <b> <i
                            class="fa fa-angle-double-right" aria-hidden="true"></i> </b> <a
                        href="{{url('/')}}/news-events"> News & Events </a><b> <i
                            class="fa fa-angle-double-right" aria-hidden="true"></i> </b>{{$news->news_name}}</p></div>
    </div>
    ...
    <div class="row serv-d-row">
        <div class="col-lg-9 col-md-8 col-sev-d">
            <div class="col-md-12 col-12-ser"><h3 class="wow fadeInUp"
                                                  style="visibility: visible; animation-name: fadeInUp;">{{$news->news_name}}</h3>
                <?php

                if($news->news_picture){
                ?>
                <img src="{{ url('/public/uploads') }}/news/{{ $news->news_picture}}"
                     class="attachment-full size-full wp-post-image" alt="" loading="lazy" width="299" height="169">
<?php } ?>
        ...
        <div class="col-lg-3 col-md-4 col-form-d">
            <div class="col-md-12 look-col wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><h3>
                ...
                <div role="form" class="wpcf7" id="wpcf7-f140-o1" dir="ltr" lang="en-US">
                    ...
                    <form action="/news_events/coronavirus-updates/#wpcf7-f140-o1" method="post" class="wpcf7-form init"
